...
const reviews = [
  ...
  { name: 'Josilene Barreto', role: 'Aluna', text: 'Super recomendo! Ótima experiência durante todo esse processo. Os instrutores Ian e Washington são extremamente pacientes e didáticos. Atendimento de qualidade...', rating: 5, initials: 'J' },
  { name: 'Daiane Mara', role: 'Aluna', text: 'Super indico a Auto Escola Caluar. Minha instrutora Luciana Pereira é nota 1000. Ensina com muita clareza e tem o coração gigante. Ensina muito bem com amor...', rating: 5, initials: 'D' },
  { name: 'Cristiane Silva', role: 'Aluna', text: 'Gratidão a Equipe Caluar! Tirei minhas 2 habilitações pela Caluar e sempre vou indicar. Agradeço aos instrutores Alípio, Lucas e Luciana...', rating: 5, initials: 'C' },
  { name: 'Isaah neves', role: 'Aluno', text: 'Imensamente grato à Autoescola Caluar. A equipe é atenciosa, os instrutores são pacientes e se importam com o aprendizado dos alunos. Recomendo!', rating: 5, initials: 'I' },
  { name: 'Aline Raquel', role: 'Aluna', text: 'Imensa gratidão à equipe CALUAR. O processo foi conduzido com extrema competência, profissionalismo e organização. Aprovada de primeira!', rating: 5, initials: 'A' },
]
          ...
          <div className="mb-8 overflow-hidden">
            ...
            >
              {reviews.map((rev, idx) => (
                <div
                  key={idx}
                  className="flex-shrink-0 w-full md:w-1/3 aspect-square"
                >
                  <div className="bg-gray-100 border border-gray-300 rounded-lg p-7 h-full flex flex-col transition-all duration-300 hover:shadow-md">
                    {/* Large Quote Marks */}
                    <div className="text-5xl text-accent/40 leading-none mb-3">"</div>

                    {/* Review Text */}
                    <p className="text-sm font-inter font-300 text-tx-muted italic mb-auto leading-relaxed line-clamp-4">
                      {rev.text}
                    </p>
