export default function AdminToggle() {
  return (
    <>
      ...
      {/* Desktop: Botão WhatsApp apenas ícone */}
      <a
        href="https://wa.me/553135633619?text=Oi%20Caluar,%20quero%20minha%20CNH!"
        target="_blank"
        rel="noopener noreferrer"
        className="hidden lg:flex fixed bottom-8 right-8 w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg hover:bg-[#1BAD56] z-30 flex items-center justify-center transition-transform hover:scale-110"
        aria-label="WhatsApp"
